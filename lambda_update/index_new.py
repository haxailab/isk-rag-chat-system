...
- 回答の最後に「※この回答はISK社内Knowledge Baseを検索して生成されました（{len(retrieved_docs)}件の関連文書を参照）」と明記する"""
                ...
                model_description = "Knowledge Base RAG対応 Claude Sonnet 4.6"
...
- 回答の最後に「※この回答は一般知識から生成されており、ISK社内文書は参照していません」と明記する"""
            ...
            model_description = "Claude Sonnet 4.6（一般知識）"
            sources = []
            source_links = []
        ...
        return {
            ...
            'body': json.dumps({
                ...
                'model': f"無機RAG powered by {model_description if 'model_description' in locals() else 'Claude Sonnet 4.6'}",
